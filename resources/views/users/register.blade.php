<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/users">
            ...
            <div class="mb-6">
                <button type="submit" class="bg-greenish text-white rounded py-2 px-4 hover:bg-black">Sign Up</button>
            </div>

            <div class="mt-8">
                <p>Already have an account?<a href="/login" class="text-greenish"> Login</a></p>
            </div>
        </form>
    </x-card>
</x-layout>
